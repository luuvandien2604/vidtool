    ...
    def _render_beat_clip(self, beat: BeatFramePlan, work_dir: Path,
        ...
        if beat.text_elements:
            ass_lines = [
                ...
                "Style: NodeLabel,DejaVu Sans,34,&H00FFFFFF,&H000000FF,&H00141619,&H90000000,-1,0,0,0,100,100,0,0,1,3,2,5,10,10,10,1",
                "Style: NodeQuote,DejaVu Sans,36,&H00F0F0F0,&H000000FF,&H00141619,&H90000000,0,-1,0,0,100,100,0,0,1,3,2,5,10,10,10,1",
                "Style: NodeTimeline,DejaVu Sans,32,&H00E6C280,&H000000FF,&H00141619,&H90000000,-1,0,0,0,100,100,0,0,1,3,1,5,10,10,10,1",
                "",
                "[Events]",
